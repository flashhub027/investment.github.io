                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="form-control-wrap">
                                        <input type="text" name="amount" class="form-control" id="invest-amount" min="0.001" data-msg-min="{{ __("More than :amount", ['amount' => '0.001']) }}" value="{{ data_get($scheme, 'amount') }}" required {{ data_get($scheme,'is_fixed') ? $restrict : '' }}>
                                    </div>
                                    <div class="form-note">{{ __('Minimum (:currency)', ['currency' => base_currency()]) }}</div>
                                </div>
                                <div class="col-6">
                                    <div class="form-control-wrap">
                                        <input type="text" name="maximum" class="form-control" id="invest-maximum" value="{{ data_get($scheme, 'maximum') }}" {{ data_get($scheme,'is_fixed') ? $restrict : '' }}>
                                    </div>
