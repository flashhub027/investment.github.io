                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <a href="javascript:void(0)" id="update-profile" class="btn btn-lg btn-primary">{{ __('Update Profile') }}</a>
                                        </li>
                                        <li>
                        ...
                        <form action="{{ route('admin.profile.update.address') }}" method="POST" class="form-validate is-alter form-profile">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-12">
                                    <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                        <li>
                                            <a href="javascript:void(0)" id="update-address" class="btn btn-lg btn-primary">{{ __('Update Address') }}</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" data-dismiss="modal" class="link link-light">{{ __('Cancel') }}</a>
                                        </li>
